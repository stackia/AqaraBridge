...
AIOT_DEVICE_MAPPING = [
        ...
        "params": [
            {
                "switch": {
                    ...
                    MK_RESOURCES: {"toggle": ("14.74.85", "_attr_is_on")},
                }
            },
            {
                "switch": {
                    ...
                    MK_RESOURCES: {"toggle": ("14.75.85", "_attr_is_on")},
                }
            },
            {
                "switch": {
                    ...
                    MK_RESOURCES: {"toggle": ("14.77.85", "_attr_is_on")},
                }
            },
            {
                "switch": {
                    ...
                    MK_RESOURCES: {"toggle": ("14.78.85", "_attr_is_on")},
                }
            },
            {
                "switch": {
                    ...
                    MK_RESOURCES: {"toggle": ("14.70.85", "_attr_is_on")},
                }
            },
            {
                "switch": {
                    ...
                    MK_RESOURCES: {"toggle": ("14.119.85", "_attr_is_on")},
                }
            },
            {
                "switch": {
                    ...
                    MK_RESOURCES: {"toggle": ("14.76.85", "_attr_is_on")},
                }
            },
            {
                "switch": {
                    ...
                    MK_RESOURCES: {"toggle": ("14.122.85", "_attr_is_on")},
                }
            },
            {
                "switch": {
                    ...
                    MK_RESOURCES: {"toggle": ("14.123.85", "_attr_is_on")},
                }
            },
        ],
    },
    ...
    ###############################调光器###########################################
    {
        ...
        "lumi.light.acn014": ["Aqara", "Bulb T1", "ZNLDP12LM"],
        "params": [
            {
                "light": {
                    MK_INIT_PARAMS: {
            ...
            },
            {
                "switch": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "power_remember",
                        "entity_category": EntityCategory.CONFIG,
                    },
                    MK_RESOURCES: {"toggle": ("8.0.2030", "_attr_is_on")},
                }
            },
        ],
    },
        ...
        "params": [
            ...
            },
            {
                "binary_sensor": {
                    ...
                    MK_RESOURCES: {"battery": ("8.0.9001", "_attr_is_on")},
                }
            },
        ],
    },
